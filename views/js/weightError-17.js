function showWeightError(){
    $('#notifications .container').html('<div class="alert alert-danger">The products exceed the maximum allowed weight. Please contact vendor for tailored solution.</div>');
